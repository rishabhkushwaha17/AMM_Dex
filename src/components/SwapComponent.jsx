	...
	const getSwapEstimateAmountTo = async (val) => {
		...
		if (props.contract !== null) {
			try {
				...
				// toast.error(err?.data?.message || "Failed to get swap estimate");
			}
		}
	};
	...
	const getSwapEstimateAmountFrm = async (val) => {
		...
		if (props.contract !== null) {
			try {
				...
				if (coin[0] === "USDC") {
					// Want val WETH (18), need how much USDC (6)?
					estimateOfAmountFrm =
					...
					// Want val USDC (6), need how much WETH (18)?
					estimateOfAmountFrm =
